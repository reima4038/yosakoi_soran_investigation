...
const ShareCreationForm: React.FC<ShareCreationFormProps> = ({
  ...
  const handlePermissionChange = (permission: 'view' | 'comment' | 'edit', checked: boolean) => {
    setFormData(prev => {
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            {formData.visibility === 'specific_users' && (
              <Autocomplete
                ...
                getOptionLabel={option =>
                  option.profile?.displayName || option.username
                }
            ...
            <Box>
              ...
              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                {([
                  { key: 'view' as const, label: '閲覧' },
                  { key: 'comment' as const, label: 'コメント' },
                ...
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      onChange={e =>
                        handleSettingsChange('allowDownload', e.target.checked)
                      }
                    />
                  }
                  label='ダウンロードを許可'
