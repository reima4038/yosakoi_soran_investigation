...
describe('VideoService', () => {
  ...
  describe('getYouTubeInfo', () => {
    it('should fetch YouTube video info successfully', async () => {
      ...
      const result = await videoService.getYouTubeInfo('https://www.youtube.com/watch?v=dQw4w9WgXcQ');
    ...
    it('should handle API errors', async () => {
      ...
      await expect(videoService.getYouTubeInfo('invalid-url'))
  ...
  describe('getVideo', () => {
    it('should fetch a single video', async () => {
      ...
      expect(mockedApiClient.get).toHaveBeenCalledWith('/videos/507f1f77bcf86cd799439011');
      expect(result).toEqual(mockVideo);
    });
  });
  ...
  describe('updateVideo', () => {
    it('should update a video successfully', async () => {
      ...
      const result = await videoService.updateVideo('507f1f77bcf86cd799439011', updateData);

      expect(mockedApiClient.put).toHaveBeenCalledWith('/videos/507f1f77bcf86cd799439011', updateData);
      expect(result).toEqual(mockVideo);
    });
  });
  ...
  describe('deleteVideo', () => {
    it('should delete a video successfully', async () => {
      ...
      expect(mockedApiClient.delete).toHaveBeenCalledWith('/videos/507f1f77bcf86cd799439011');
    });
  });
  ...
  describe('Error Handling', () => {
    it('should propagate API errors', async () => {
      ...
      await expect(videoService.getVideo('invalid-id'))
